...
- ☁️ **AWS S3 Automation & AI Dashboard**  
  Automated S3 operations + ML-based cost optimization + AI summarization  

- 📊 **Holiday Package Purchase Prediction**  
  ML model to predict customer behavior using Scikit-learn  
